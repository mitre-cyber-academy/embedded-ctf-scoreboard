...
Challenge.create!(name: 'Challenge B', point_value: 100, flags: [ Flag.create(flag: "flag") ], starting_state: 'open', category: category)
Challenge.create!(name: 'Challenge C', point_value: 100, flags: [ Flag.create(flag: "flag") ], starting_state: 'open', category: category)
Challenge.create!(name: 'Challenge D', point_value: 100, flags: [ Flag.create(flag: "flag") ], starting_state: 'open', category: category)
...
Challenge.create!(name: 'Challenge F', point_value: 100, flags: [ Flag.create(flag: "flag") ], starting_state: 'open', category: category)
Challenge.create!(name: 'Challenge G', point_value: 100, flags: [ Flag.create(flag: "flag") ], starting_state: 'open', category: category)
Challenge.create!(name: 'Challenge H', point_value: 100, flags: [ Flag.create(flag: "flag") ], starting_state: 'open', category: category)
