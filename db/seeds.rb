...
# crypto
category1 = Category.create!(name: 'Crypto', game: game)
category2 = Category.create!(name: 'Forensics', game: game)
category3 = Category.create!(name: 'Web', game: game)
category4 = Category.create!(name: 'Networking', game: game)
category5 = Category.create!(name: 'Grab Bag', game: game)
